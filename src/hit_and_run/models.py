...
class LifecycleAction:
    ...
    PROFIT_BANK_100_EXIT = "PROFIT_BANK_100_EXIT"
    TRAILING_PROFIT_LOCK_EXIT = "TRAILING_PROFIT_LOCK_EXIT"
    ...
    ALL_ACTIONS = {
        HOLD, TAKE_PROFIT, PROFIT_BANK_100_EXIT, TRAILING_PROFIT_LOCK_EXIT,
        EDGE_DECAY_EXIT, MOMENTUM_REVERSAL_EXIT, ROTATE, STOP_LOSS_EXIT
    }
