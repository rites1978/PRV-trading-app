...
def get_core_compounding_status():
    ...
    return {
        ...
        "active_strategy_id": active_strat,
        "git_commit": git_commit,
        "current_nav": float(summary.get("total_value", 49896.38)),
        "free_cash": float(summary.get("available_cash", 49896.38)),
        ...
        "latest_strategy_decision": (status_data.get("decision") if isinstance(status_data, dict) and status_data.get("decision") else "HOLD"),
        ...
        "reason": (status_data.get("reason") or "") if isinstance(status_data, dict) else "",
        ...
        "forward_practice_evidence": {
            ...
            "current_nav_gbp": float(summary.get("total_value", 49896.38)),
...
def get_strategy_forward_baseline():
    ...
    return {
        ...
        "CORE_COMPOUNDING_V1_FORWARD_BASELINE_NAV": getattr(settings, "CORE_COMPOUNDING_V1_FORWARD_BASELINE_NAV", 49896.38),
        "CORE_COMPOUNDING_V1_STRATEGY_PNL_AT_LAUNCH": getattr(settings, "CORE_COMPOUNDING_V1_STRATEGY_PNL_AT_LAUNCH", 0.00),
        "CURRENT_BROKER_NAV": float(summary.get("total_value", 49896.38)),
        "CURRENT_FREE_CASH": float(summary.get("available_cash", 49896.38)),
